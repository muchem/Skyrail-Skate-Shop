...
{
    public partial class Skateboard_Completes : System.Web.UI.Page
    {
        ...
        public void RenderSkateboards()
        {
             if(Connection.State == ConnectionState.Closed)
            {
                Connection.Open();
                SqlDataAdapter sqladpt = new SqlDataAdapter("SelectSkateboards", Connection);
